...
library(pander)
library(network)
bib <- read.bibtex("/Users/kjoseph/Dropbox/Kenny/papers/current/net_models/bib.bibtex")
source("/Users/kjoseph/Dropbox/Kenny/papers/current/net_models/functions.R")
```
